...
$sql = "SELECT a.titre, a.description, a.contenu, a.image, t.name AS theme_name, a.date_creation
        FROM articles a
...
$sql = "SELECT c.*, u.prenom, u.nom FROM comments c LEFT JOIN users u ON c.user_id = u.id WHERE c.article_id = :article_id ORDER BY c.date_creation DESC";
$stmt = $pdo->prepare($sql);
    ...
    <div class="comments-section mt-5">
        ...
        <form method="post" class="mb-4">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="contenu" name="contenu" rows="3" maxlength="1000" required></textarea>
            </div>
            <button type="submit" name="commenter" class="btn btn-primary">Publier</button>
        </form>
        <!-- Liste des commentaires -->
        <?php if (empty($comments)): ?>
            <div class="text-white-50">Aucun commentaire pour cet article.</div>
        <?php else: ?>
